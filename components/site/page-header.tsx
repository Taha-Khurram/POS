  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div aria-hidden className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(120%_85%_at_50%_-25%,var(--wash-near)_0%,var(--wash-mid)_50%,var(--wash-far)_100%)]" />
        ...
        <div className="glow left-[18%] top-[38%] h-32 w-32 bg-iris-400/26 blur-[54px]" />
